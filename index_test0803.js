...
winston.configure({
  ...
  transports: [ 
    new DailyRotateFile({
      filename: '13-produce-un-test1-%DATE%.log',
...
//  for (let moduleKey of ['6-32-21', '6-34-23', '6-34-24', '6-35-23', '6-35-24']) { //// TEMP
  for (let moduleKey of ['5-15-12', '5-17-11']) { 
...
const main = async () => {
  winston.info(`${iso()}: prototype11 production started.`)
  await getScores()
  queueTasks()
  queue.on('drain', () => {
    shutdown()
